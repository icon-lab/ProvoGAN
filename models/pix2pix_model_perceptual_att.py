...
class Pix2PixModel(BaseModel):
    ...
    def backward_D(self):
        ...
        pred_fake,att_fake = self.netD(fake_AB.detach())
        self.att_fake=att_fake
        self.loss_D_fake = self.criterionGAN(pred_fake, False)

        # Real
        real_AB = torch.cat((self.real_A, self.real_B), 1)
        pred_real,att_real = self.netD(real_AB)
        self.att_real=att_real
    ...
    def backward_G(self):
        ...
        pred_fake,att_fake = self.netD(fake_AB)
    ...
    def get_current_visuals(self):
        ...
        att_fake = util.tensor2im(torch.unsqueeze(self.att_fake.data, 0))
        att_real = util.tensor2im(torch.unsqueeze(self.att_real.data, 0))
        return OrderedDict([('real_A', real_A), ('fake_B', fake_B), ('real_B', real_B),('att_fake', att_fake), ('att_real', att_real)])
