...
if __name__ == '__main__':
    ...
    #            break
            ...
            recovered_im=np.float32(load_nifty_volume_as_array(filename=target_subject+out_type+'_syn_3dpro_'+order_c+'_2.nii'))
            ...
            save_array_as_nifty_volume(fake_syn, filename=target_subject+out_type+'_syn_3dpro_'+order_c+'_3.nii')
