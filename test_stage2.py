...
if __name__ == '__main__':
    ...
    #            break
            ...
            recovered_im=np.float32(load_nifty_volume_as_array(filename=target_subject+out_type+'_syn_3dpro_'+order_c[0]+'_1.nii'))
            ...
            for ind in range(slice_size):
                ...
                if order_c[1]=='A':
                    data_x=np.array([in_im1[ind,:,:],in_im2[ind,:,:],recovered_im[:,ind,:]])
                ...
                data_fake1=(data_fake1*1.0-0.5)*2
                ...
                data={'A': torch.from_numpy(data_x), 'B':torch.from_numpy(data_y),'fake1':torch.from_numpy(data_fake1), 'A_paths':target_subject, 'B_paths':target_subject}  
            ...
            save_array_as_nifty_volume(fake_syn, filename=target_subject+out_type+'_syn_3dpro_'+order_c+'_2.nii')
